    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle loaderArgs) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                Log.i("MainActivity", "locationQuery : " +locationQuery);
                ...
                try {
                    ...
                    Log.i("MainActivity", "simpleJsonWeatherData: " +simpleJsonWeatherData);
                    for(String data : simpleJsonWeatherData){
                        Log.i("MainActivity", "simpleJsonWeatherData: " +data);
