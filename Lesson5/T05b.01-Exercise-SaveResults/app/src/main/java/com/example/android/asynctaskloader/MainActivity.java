...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secondActivityButton = (Button) findViewById(R.id.btn_secondAct);
        ...
        /*if(savedInstanceState != null){
            if(savedInstanceState.containsKey(SEARCH_QUERY_URL_EXTRA)){
                String url = savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA);
                mUrlDisplayTextView.setText(url);
            }
            if(savedInstanceState.containsKey(SEARCH_RESULTS_RAW_JSON)){
                String json = savedInstanceState.getString(SEARCH_RESULTS_RAW_JSON);
...
public boolean onOptionsItemSelected(MenuItem item) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String saveStr = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL_EXTRA, saveStr);
        String saveJson = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_RAW_JSON, saveJson);
    }*/
