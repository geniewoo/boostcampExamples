...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mWordTextView, mDefinithionTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDefinithionTextView = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        mData.moveToPosition(rowNum);
        int nameIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD);
        mWordTextView.setText(mData.getString(nameIndex));
        mDefinithionTextView.setText("");
    ...
    public void showDefinition() {
        int definitionIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
        mDefinithionTextView.setText(mData.getString(definitionIndex));
        rowNum++;
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            mData = cursor;
            rowNum = 1;
            Log.i("Main", String.valueOf(cursor.getCount()));
            nextWord();
